...
const float EARTH_MASS_KG = 5.972e24;
const float G_CONST_SI = 6.67430e-11;
const float EARTH_RAD_EQ_M = 6378137.0;
const float J2 = 1.0826e-3;
...
const float G_EARTH = (6.673e-11 * EARTH_MASS_KG * 60 * 60 / (EARTH_RAD_EQ_M * EARTH_RAD_EQ_M * EARTH_RAD_EQ_M)); //length units of earth radius, time units minutes
